...
saveRDS(art_ter_RR, file = "rdtype_strat/multi_art_ter_RR.rds")
...
saveRDS(col_ter_RR, file = "rdtype_strat/multi_col_ter_RR.rds")
...
saveRDS(loc_ter_RR, file = "rdtype_strat/multi_loc_ter_RR.rds")
...
saveRDS(oth_ter_RR, file = "rdtype_strat/multi_oth_ter_RR.rds")
...
(p3_arterial|p3_collector|p3_local |p3_other) +
  plot_annotation(
    ...
    subtitle = "Multivariate analysis with image prediction data and selected GIS road characteristics",
