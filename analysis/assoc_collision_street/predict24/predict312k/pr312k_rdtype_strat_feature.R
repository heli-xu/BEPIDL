...
saveRDS(art_ter_RR, file = "rdtype_strat312k/art_ter_RR.rds")
...
saveRDS(col_ter_RR, file = "rdtype_strat312k/col_ter_RR.rds")
...
test <- fit_feature_strat("sidewalk", local_collision)
summary(test)
...
saveRDS(loc_ter_RR, file = "rdtype_strat312k/loc_ter_RR.rds")
...
saveRDS(oth_ter_RR, file = "rdtype_strat312k/oth_ter_RR.rds")
