...
Building on the previous report on exploring target data files and variable distribution, I'd like to join the spatial information from ZAT folder with the variables from `ZAT_INDICADORES.xlsx` and visualize the geo-referenced data.
